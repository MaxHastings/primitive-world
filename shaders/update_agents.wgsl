...
fn main(@builtin(global_invocation_id) id:vec3<u32>){
 ...
 let old=a.position;a.position=clamp(old+movement,vec2<f32>(0),params.world_size.xy);a.velocity=a.position-old;a.moved=a.velocity;let distance=length(a.velocity);a.spent=distance*params.time_and_costs.z;a.energy=max(0.0,a.energy-a.spent);
