...
struct Agent {
 ...
 hidden:array<f32,HIDDEN_COUNT>,lived_ticks:u32,cognitive_padding:u32,mutation_scale:f32,
};
...
struct Decision {
 ...
 force:vec2<f32>,candidate:array<f32,HIDDEN_COUNT>,hidden:array<f32,HIDDEN_COUNT>,update_gates:array<f32,HIDDEN_COUNT>,
 outputs:array<f32,OUTPUT_COUNT>,memory_write_cost:f32,decision_padding:vec3<u32>,inputs:array<f32,INPUT_COUNT>,decision_end_padding:u32,
};
struct SimParams {
